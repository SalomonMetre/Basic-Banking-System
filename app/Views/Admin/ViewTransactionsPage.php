                        ...
                        <tbody style="overflow-y: scroll;">
                            ...
                            ?>
                                <tr>
                                    ...
                                    ?>
                                    <td>
                                        <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#modelId<?= $transaction['Id'] ?>">
                                            Edit
                                        </button>
                                        <div class="modal fade" id="modelId<?= $transaction['Id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form method="POST" action="admin_editTransaction/">
                                                        <div class="modal-body">
                                                            <input type="text" name="TransId" value="<?= $transaction['Id'] ?>" hidden>
                                                            <input type="text" name="UserId" value="<?= $transaction['UserId'] ?>" hidden>
                                                            <input type="text" value="<?= $transaction['Type'] ?>" name="Type" hidden>
                                                            <input type="text" value="<?= $transaction['Amount'] ?>" name="Amount" hidden>
                                                            <input type="text" name="CurrentStatus" value="<?= $transaction['Status'] ?>" hidden>
                                                            <select name="NewStatus" id="" style="width:100%;padding:1%;">
                                    ...
                                    ?>
                                    <td>
                                    <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#modelId<?= $transaction['Id'] ?>" <?php if($transaction['Status']!='Pending'){  ?> disabled <?php }?>>
                                      Edit
                                    </button>
                                    <div class="modal fade" id="modelId<?= $transaction['Id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                        ...
                                        <form method="POST" action="admin_reverseTransfer/">
                                                <div class="modal-body">
                                                    <input type="text" name="TransferId" value="<?= $transaction['Id'] ?>" hidden>
                                                    <input type="text" name="FromId" value="<?= $transaction['UserId'] ?>" hidden>
                                                    <input type="text" name="ToId" value="<?= $transaction['ToId'] ?>" hidden>
                                                    <input type="text" name="Amount" value="<?= $transaction['Amount'] ?>" hidden>
                                                    <select name="NewStatus" id="" style="width:100%;">
