        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 left-content" style="text-align: center; border-top-right-radius: 5%; margin-top:7%; display:block;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10"> <a href="<?= base_url("user_TransHistoryPage/") ?>" style="text-decoration: none; color:white;"> Loans History </a> </div>
                </div>
            ...
            <div class="col-sm-12 col-md-9 right-content" style="display: inline;">
                <div class="row" style="margin-top: 5%; margin-bottom:3%;">
                    ...
                    <div class="col-md-4"></div>
                    <div class="col-md-4" style="padding:2%; background-color:#021C03; margin:-1%; border-radius:5%;text-align:center;font-weight:bold; font-size:1em;color:white;"> Total Loans : <?= session()->get('loanAmount') ?> </div>
                </div>
