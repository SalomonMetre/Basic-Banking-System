  ...
  <div>
    <header>
      <div class="logo-container">
        ...
        <a href="<?php echo base_url('showSignUpPage/'); ?>" class="sign-in btn btn-success btn-md btn-block"> Sign Up </a>
      </div>
    </header>
    <div class="container-fluid form-container flex-nowrap">
      <div class="row" style="text-align: center; color:#018B71;">
        <h1 style="padding-bottom: 5%; margin-top:-1%;">Sign In</h1>
        <div class="row form-row">
          <form method="POST" action="<?= base_url("signIn/") ?>" class="row">
            ...
            <div class="row">
              <button class="btn-success" style="margin-left:10%; margin-right:10%;padding: 2%; width:80%; background-color:#124B44; font-size:22px;" type="submit"> Sign In </button>
            </div>
        </div>
        </form>
      </div>
